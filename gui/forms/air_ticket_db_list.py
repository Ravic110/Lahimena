"""Air ticket DB list (data-hotel.xlsx / avion)."""
...
class AirTicketDBList:
    ...
    def _delete_selected(self):
        ...
        confirm = messagebox.askyesno(
            "Confirmation",
            "Supprimer cette ligne de la base avion (data-hotel.xlsx) ?",
        )
        if not confirm:
            return
        ...
        success = delete_avion_db_row(row_number)
        if success:
