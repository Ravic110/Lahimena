...
class HotelForm:
    ...
    def _create_form_content(self, parent):
        ...
        tk.Label(
            row1, text="ID Hôtel *", font=LABEL_FONT, fg=TEXT_COLOR, bg=MAIN_BG_COLOR
        ).grid(row=0, column=0, sticky="w", pady=2)
        self.entry_id = tk.Entry(
            row1, font=ENTRY_FONT, width=15, bg=INPUT_BG_COLOR, fg=TEXT_COLOR
        )
        ...
        self.entry_categorie = tk.Entry(
            row2, font=ENTRY_FONT, width=10, bg=INPUT_BG_COLOR, fg=TEXT_COLOR
        )
