"""
Combined page for paramétrage form and summary.
"""

import tkinter as tk

from config import MAIN_BG_COLOR
from gui.forms.parametrage_form import ParametrageForm
from gui.forms.parametrage_summary import ParametrageSummary


class ParametragePage:
    """Display paramétrage form and summary on the same page."""
