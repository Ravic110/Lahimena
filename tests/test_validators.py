...
class TestPhoneValidation:
    ...
    def test_valid_phone_numbers(self):
        ...
        for country_code, phone in valid_phones:
            ...
            assert isinstance(
                result, bool
            ), f"Should return bool for {country_code}:{phone}"
...
class TestRequiredFieldValidation:
    ...
    def test_valid_strings(self):
        ...
        valid_fields = ["John Doe", "0301234567", "info@lahimena.mg", "123456789"]
...
class TestDateFormatValidation:
    ...
    def test_valid_date_formats(self):
        ...
        valid_dates = ["01/01/2026", "31/12/2025", "05/02/2026", "01/01/2000"]
    ...
    def test_invalid_date_formats(self):
        ...
        for date in invalid_dates:
            assert not re.match(
                date_pattern, date
            ), f"Date {date} should not match pattern"
