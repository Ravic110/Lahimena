...
from gui.forms.client_air_ticket_cotation import (  # noqa: E402
    _build_initial_rows,
    _make_row,
    _recompute_row,
    _validate_rows,
...
class TestValidateRows(unittest.TestCase):
    ...
    def test_missing_ville_depart(self):
        ...
        self.assertIn(
            "Ligne 1 : ville_depart et ville_arrivee sont obligatoires.", errors
        )
    ...
    def test_negative_nb_adultes(self):
        row = _make_row(
            ville_depart="Antananarivo", ville_arrivee="Nosy Be", nb_adultes="-1"
        )
        errors = _validate_rows([row])
